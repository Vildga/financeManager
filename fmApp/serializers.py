...
class IncomeExpenseTrendSerializer(serializers.Serializer):
    income_trend = serializers.DictField(child=serializers.DecimalField(max_digits=10, decimal_places=2))
    expense_trend = serializers.DictField(child=serializers.DecimalField(max_digits=10, decimal_places=2))